...
# Run application: wrapper filters NNPACK C++ warning from gunicorn stderr so logs stay readable
# (Pre-built PyTorch wheels often ignore USE_NNPACK=0; filtering at process level is reliable.)
